...
import pages.AssignLeavePageWithPageFactory;
import pages.LoginPageWithPageFactory;
import pages.SearchAdminWithPageFactory;
import pages.SearchDirectoryPageWithPageFactory;
...
/**
	...
	public class OrangehrmTest {
		...
		AssignLeavePageWithPageFactory page;
		SearchAdminWithPageFactory adminpage;
		SearchDirectoryPageWithPageFactory dirpage;
		/**
		...
		public void admin_is_clicked() throws Throwable {
			adminpage=PageFactory.initElements(driver, SearchAdminWithPageFactory.class);
		...
		public void directory_is_clicked() throws Throwable {
			dirpage=PageFactory.initElements(driver, SearchDirectoryPageWithPageFactory.class);
		...
		public void in_dashboard_assign_leave_is_clicked() throws Throwable {
			page=PageFactory.initElements(driver, AssignLeavePageWithPageFactory.class);
			page.clickdbassign();
